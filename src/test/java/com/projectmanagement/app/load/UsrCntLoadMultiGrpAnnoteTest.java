...
/**
 * The Class UsrCntLoadMultiGrpAnnoteTest.
 */
@ExtendWith({ ParallelLoadExtension.class })
public class UsrCntLoadMultiGrpAnnoteTest {

	/**
	 * Test users controller load.
	 */
	@Test
	@LoadWith("load_generation.properties")
	@TestMappings({ @TestMapping(testClass = UsersControllerTest.class, testMethod = "testGetAllUsersPositiveFlow"),
