...
/**
 * The Class UsrServiceLoadMultiGrpAnnoteTest.
 */
@ExtendWith({ ParallelLoadExtension.class })
public class UsrServiceLoadMultiGrpAnnoteTest {

	/**
	 * Test users service load.
	 */
	@Test
	@LoadWith("load_generation.properties")
	@TestMappings({ @TestMapping(testClass = UsersServiceImplTest.class, testMethod = "testGetAllUsersPositiveFlow"),
