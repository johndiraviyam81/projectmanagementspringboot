...
/**
 * The Class TskServiceLoadMultiGrpAnnoteTest.
 */
@ExtendWith({ ParallelLoadExtension.class })
public class TskServiceLoadMultiGrpAnnoteTest {

	/**
	 * Test tasks service load.
	 */
	@Test
	@LoadWith("load_generation.properties")
	@TestMappings({ @TestMapping(testClass = TasksServiceImplTest.class, testMethod = "testGetAllTasksPositiveFlow"),
