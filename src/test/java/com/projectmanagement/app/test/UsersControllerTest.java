...
class UsersControllerTest {
	...
	String UserDto4ErrorJson="{\"userId\":null,\"firstName\":null,\"lastName\":null,\"employeeId\":null,\"message\":\"Error has been occured while creating user\"}";
	
	
	String UserDto5ErrorJson="{\"userId\":null,\"firstName\":null,\"lastName\":null,\"employeeId\":null,\"message\":\"Error has been occured while updating user\"}";
	...
	this.userDto4Error.setFirstName("cuba");
	this.userDto4Error.setEmployeeId("abcde");
	
	this.deleteRecord.setDeleteId("5");
	...
	when(usersService.save(new UserDTO())).thenThrow(NullPointerException.class);
