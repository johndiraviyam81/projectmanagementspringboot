...
class TasksControllerTest {
	...
	String taskDto1ErrorJson = "{\"taskId\":\"14\",\"parentTaskId\":null,\"projectId\":\"1\",\"userId\":\"1\",\"taskName\":\"Error Task of this Project 1\",\"startDate\":\"Elmer2019-11-29\",\"endDate\":\"2019-11-30\",\"priority\":\"20\",\"status\":null,\"message\":null,\"parentTaskName\":null,\"projectName\":\"Solr elmer project\",\"userName\":\"John Diraviyam\"}";

	String taskDto1ReturnJson = "{\"taskId\":\"14\",\"parentTaskId\":null,\"projectId\":\"1\",\"userId\":\"1\",\"taskName\":\"Error Task of this Project 1\",\"startDate\":\"Elmer2019-11-29\",\"endDate\":\"2019-11-30\",\"priority\":\"20\",\"status\":null,\"message\":\"Error has been occured while creating task\",\"parentTaskName\":null,\"projectName\":\"Solr elmer project\",\"userName\":\"John Diraviyam\"}";
	
	String taskDto1UpdateReturnJson = "{\"taskId\":\"14\",\"parentTaskId\":null,\"projectId\":\"1\",\"userId\":\"1\",\"taskName\":\"Error Task of this Project 1\",\"startDate\":\"Elmer2019-11-29\",\"endDate\":\"2019-11-30\",\"priority\":\"20\",\"status\":null,\"message\":\"Error has been occured while updating task\",\"parentTaskName\":null,\"projectName\":\"Solr elmer project\",\"userName\":\"John Diraviyam\"}";
	...
	void testAddTaskPositiveFlow() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
				...
				.accept(MediaType.APPLICATION_JSON).content(this.taskDto1Json).contentType(MediaType.APPLICATION_JSON);
		MockHttpServletResponse response = mvc.perform(requestBuilder).andExpect(status().isOk()).andReturn()
				.getResponse();
	...
	void testAddTaskExceptionFlow() throws Exception {
		when(tasksService.save(taskErrorDto1)).thenThrow(NullPointerException.class);

		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
				.post(ProjectManagementConstants.URL_TASK_Service + ProjectManagementConstants.URL_TASK_addTask)
				.accept(MediaType.APPLICATION_JSON).content(this.taskDto1ErrorJson).contentType(MediaType.APPLICATION_JSON);
		MockHttpServletResponse response = mvc.perform(requestBuilder).andExpect(status().isBadRequest()).andReturn()
				.getResponse();
		assertEquals(this.taskDto1ReturnJson, response.getContentAsString());
	}
	...
	void testUpdateTaskPositiveFlow() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
				...
				.accept(MediaType.APPLICATION_JSON).content(this.taskDto2Json).contentType(MediaType.APPLICATION_JSON);
		MockHttpServletResponse response = mvc.perform(requestBuilder).andExpect(status().isOk()).andReturn()
				.getResponse();
	...
	void testUpdateTaskExceptionFlow() throws Exception {
		...
		MockHttpServletResponse response = mvc.perform(requestBuilder).andExpect(status().isBadRequest()).andReturn()
				.getResponse();
		assertEquals(this.taskDto1UpdateReturnJson, response.getContentAsString());
	}
	...
	void testGetTaskByParentPositiveFlow() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
				.get(ProjectManagementConstants.URL_TASK_Service + ProjectManagementConstants.URL_TASK_Parent_Task_Test
						+ "/7")
				.accept(MediaType.APPLICATION_JSON).content("7").contentType(MediaType.APPLICATION_JSON);
		MockHttpServletResponse response = mvc.perform(requestBuilder).andExpect(status().isOk()).andReturn()
				.getResponse();
	...
	void testGetTaskPositiveFlow() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
				.get(ProjectManagementConstants.URL_TASK_Service + ProjectManagementConstants.URL_TASK_update + "/13")
